...
class RecipesModel : ObservableObject {
    ...
    func loadRecipes(query : String, completion: @escaping () -> Void) {
...
struct RecipeModel: Codable, Identifiable, Hashable {
    ...
    static func == (lhs: RecipeModel, rhs: RecipeModel) -> Bool {
        return lhs.recipe == rhs.recipe && lhs.isLiked == rhs.isLiked
    }
...
enum SortBy: String, CaseIterable {
    case addedtime, name, cookingtime, fat, carbs, protein, calories
