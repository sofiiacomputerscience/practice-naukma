...
struct RecipeCellView: View {
    ...
    var body: some View {
        ZStack {
            ...
            HStack {
                AsyncImage(url: URL(string: recipeModel.recipe.image)) { phase in
                    switch phase {
                    case .empty:
                        ProgressView()
                ...
                VStack(alignment: .leading) {
                    ...
                    Text(recipeModel.recipe.source)
                        .font(.subheadline)
                ...
                Button(action: {
                    recipeModel.isLiked.toggle()
                    
                    if recipeModel.isLiked {
    ...
    static var previews: some View {
        let recipe = Recipe(uri: "http://www.edamam.com/ontologies/edamam.owl#recipe_16f636c6ef7f82621fa9bc1ab08c1c96",
                            ...
                            totalDaily: AllNutrients(
                                ...
                                carbs: Nutrient(label: "carbs", quantity: 172.82856749999996, unit: "g"),
                                protein: Nutrient(label: "protein", quantity: 16.09692, unit: "g")))
        RecipeCellView(recipeModel: .constant(RecipeModel(recipe: recipe, isLiked: false)))
